      ...
      <div className={styles.container}>
        ...
        <div className={styles.profileHeader}>
          ...
          <div className={styles.profileInfo}>
            <h2 className={styles.name}>{adminUser?.full_name || adminUser?.email}</h2>
            ...
            <div className={styles.infoGrid}>
              <div className={styles.infoItem}>
                ...
                <span className={styles.infoValue}>
                  {adminUser?.full_name || <span className={styles.empty}>Not set</span>}
                </span>
              </div>
              <div className={styles.infoItem}>
                <span className={styles.infoLabel}>Email</span>
                <span className={styles.infoValue}>{adminUser?.email}</span>
              </div>
              <div className={styles.infoItem}>
        ...
        <div className={styles.card}>
          ...
          <div className={styles.cardContent}>
            <p className={styles.helpText}>
              Enable push notifications to receive instant updates about system alerts, driver activities, and important events.
            </p>
